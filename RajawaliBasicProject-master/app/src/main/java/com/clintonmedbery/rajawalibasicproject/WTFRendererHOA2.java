...
public class WTFRendererHOA2 extends RajawaliRenderer {
...
//    private WTFCube cube;
    ...
    private WTFCube[] cbs = new WTFCube[100 * 2];
    public WTFRendererHOA2(Context context) {
        super(context);
...
//        getCurrentScene().addChild(cube);
        int ii = 0;
        WTFMaterial mat = new WTFMaterial(false, false);
        for(int i = 0; i < 20; i++) {
            for (int j = 0; j < 10; j++) {
                WTFCube cb = new WTFCube(0.25f);
                cb.setMaterial(mat);
//                cb.addAuxiliaryLine();
