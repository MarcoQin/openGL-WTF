...
//        orthoCam.setLookAt(0,-0.5,0);
        ...
        cube = new WTFLineCube(0.25f);
        cube.setColor(253, 169, 40);
//        cube.addAuxiliaryLine();
        cube.addGlobalAuxiliaryLine(getCurrentScene());
        cube.setPivot(new Vector3(0, -0.5, 0));

        WTFLinePlane plane = new WTFLinePlane(3);
        getCurrentScene().addChild(plane);

        toy = new WTFLineToy();
        toy.setScale(0.5);
        getCurrentScene().addChild(toy);
